...
(lib.turbine_ring = function(mode,startPosition,loop) {
	...
	this.shape_101.graphics.f("rgba(255,255,255,0.388)").s().p("Al0KjQkYibhYkzQhYkyCakYQCbkXEzhYQEyhYEYCbQEXCbBYEyQBYEyibEXQiaEYkzBYQhwAghqAAQi9AAiyhig");
	this.shape_101.setTransform(100.6,101.1,1.18,1.18);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{fade_in:0,click:28});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(27).call(this.frame_27).wait(12).call(this.frame_39).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},2).to({regX:130,scaleX:1,scaleY:1,x:130.1},23).wait(3).to({regX:129.9,rotation:150,x:130.2,y:188.4},6).wait(1).to({regX:129.8,scaleX:1.18,scaleY:1.18,rotation:150.1,x:130.3},2).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},2).to({_off:true,regX:-35.9,scaleX:1,scaleY:1,rotation:180,y:188.4},23).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},23).to({startPosition:0},3).to({startPosition:0},6).to({startPosition:0},1).to({scaleX:1.15,scaleY:1.15},4).wait(1));
...
(lib.vmaxClip = function(mode,startPosition,loop) {
	...
	this.seatSelector.setTransform(172.2,325,0.406,0.406,-140.2,0,0,159.5,187.6);

	this.seatSelector_1 = new lib.fullSelector();
	this.seatSelector_1.parent = this;
	this.seatSelector_1.setTransform(742.6,324.9,0.406,0.406,-59,0,0,159.7,187.6);

	this.seatSelector_2 = new lib.fullSelector();
	this.seatSelector_2.parent = this;
	this.seatSelector_2.setTransform(496,273.4,0.332,0.332,-119,0,0,159.7,187.3);

	this.seatSelector_3 = new lib.fullSelector();
	this.seatSelector_3.parent = this;
	this.seatSelector_3.setTransform(295.4,313,0.246,0.246,-14,0,0,159.9,187.2);

	this.seatSelector_4 = new lib.fullSelector();
	this.seatSelector_4.parent = this;
	this.seatSelector_4.setTransform(584.5,67.9,0.169,0.169,31,0,0,159.7,187);

	this.seatSelector_5 = new lib.fullSelector();
	this.seatSelector_5.parent = this;
	this.seatSelector_5.setTransform(488.6,132.7,0.169,0.169,112.5,0,0,159.5,187.2);

	this.seatSelector_6 = new lib.fullSelector();
	this.seatSelector_6.parent = this;
	this.seatSelector_6.setTransform(273.2,148.7,0.169,0.169,-157.5,0,0,159.5,187.2);

	this.instance = new lib.vmax();
	this.instance.parent = this;
	this.instance.setTransform(63.6,0.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.seatSelector_6},{t:this.seatSelector_5},{t:this.seatSelector_4},{t:this.seatSelector_3},{t:this.seatSelector_2},{t:this.seatSelector_1},{t:this.seatSelector}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.vmaxClip, new cjs.Rectangle(-0.5,0.7,913.1,469), null);


// stage content:
(lib.Service_animation = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_48 = function() {
		...
		*/
		...
		this.seatSelector.addEventListener("click", returnCategory);
		
		function returnCategory(e) {
			// Start your custom code
			// This example code displays the words "Mouse clicked" in the Output panel.
			this.seatSelector.gotoAndPlay("click");
	...
	this.rwSelector.setTransform(121.7,407.3,0.406,0.406,-140.2,0,0,159.5,187.6);

	this.instance = new lib.vmaxClip();
	this.instance.parent = this;
	this.instance.setTransform(405.6,327.4,1,1,0,0,0,456.1,245);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.rwSelector}]},23).to({state:[{t:this.instance}]},25).wait(1));

	// fwSelector
	this.fwSelector = new lib.fullSelector();
	this.fwSelector.parent = this;
	this.fwSelector.setTransform(692.1,407.3,0.406,0.406,-59,0,0,159.7,187.6);
	this.fwSelector._off = true;

	this.timeline.addTween(cjs.Tween.get(this.fwSelector).wait(20).to({_off:false},0).to({_off:true},28).wait(1));

	// engineSelector
	this.seatSelector = new lib.fullSelector();
	this.seatSelector.parent = this;
	this.seatSelector.setTransform(445.5,355.8,0.332,0.332,-119,0,0,159.7,187.3);
	this.seatSelector._off = true;

	this.timeline.addTween(cjs.Tween.get(this.seatSelector).wait(17).to({_off:false},0).to({_off:true},31).wait(1));

	// exhaustSelector
	this.exhaustSelector = new lib.fullSelector();
	this.exhaustSelector.parent = this;
	this.exhaustSelector.setTransform(244.9,395.3,0.246,0.246,-14,0,0,159.9,187.2);
	this.exhaustSelector._off = true;

	this.timeline.addTween(cjs.Tween.get(this.exhaustSelector).wait(12).to({_off:false},0).to({_off:true},36).wait(1));

	// controlSelector
	this.controlSelector = new lib.fullSelector();
	this.controlSelector.parent = this;
	this.controlSelector.setTransform(533.9,150.3,0.169,0.169,31,0,0,159.7,187);
	this.controlSelector._off = true;

	this.timeline.addTween(cjs.Tween.get(this.controlSelector).wait(7).to({_off:false},0).to({_off:true},41).wait(1));

	// tankSelector
	this.tankSelector = new lib.fullSelector();
	this.tankSelector.parent = this;
	this.tankSelector.setTransform(438.1,215,0.169,0.169,112.5,0,0,159.5,187.2);

	this.timeline.addTween(cjs.Tween.get(this.tankSelector).to({_off:true},48).wait(1));

	// seatSelector
	this.seatSelector_1 = new lib.fullSelector();
	this.seatSelector_1.parent = this;
	this.seatSelector_1.setTransform(222.7,231.1,0.169,0.169,-157.5,0,0,159.5,187.2);
	this.seatSelector_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.seatSelector_1).wait(3).to({_off:false},0).to({_off:true},45).wait(1));

	// Vmax
	this.instance_1 = new lib.vmax();
	this.instance_1.parent = this;
	this.instance_1.setTransform(13,83);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},48).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(413,383,775,434);
// library properties:
lib.properties = {
	id: 'F6ED65FDA864AF42BA103B378189BF06',
	width: 800,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/vmax.png?1502919085100", id:"vmax"}
	],
	preloads: []
};
...
an.compositions['F6ED65FDA864AF42BA103B378189BF06'] = {

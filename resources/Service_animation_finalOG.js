...
p.nominalBounds = new cjs.Rectangle(0,0,608,350);// helper functions:
...
(lib.vmaxClip = function(mode,startPosition,loop) {
	...
	this.rwSelector.setTransform(121.2,339.5,0.406,0.406,-140.2,0,0,159.5,187.6);

	this.fwSelector = new lib.fullSelector();
	this.fwSelector.parent = this;
	this.fwSelector.setTransform(807.6,339.9,0.406,0.406,-59,0,0,159.7,187.6);
	...
	this.controlSelector.setTransform(642.9,63.7,0.312,0.312,31,0,0,160,186.8);

	this.tankSelector = new lib.fullSelector();
	this.tankSelector.parent = this;
	this.tankSelector.setTransform(454.4,93.9,0.297,0.297,112.5,0,0,159.5,186.8);

	this.seatSelector = new lib.fullSelector();
	this.seatSelector.parent = this;
	this.seatSelector.setTransform(240.9,145.3,0.298,0.298,-157.5,0,0,134.3,149.2);

	this.instance = new lib.vmax();
	this.instance.parent = this;
	this.instance.setTransform(-38,-54,1.626,1.626);
...
}).prototype = getMCSymbolPrototype(lib.vmaxClip, new cjs.Rectangle(-51.5,-54,1029.1,569.1), null);
...
p.nominalBounds = new cjs.Rectangle(492.4,301.1,1029.1,569.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/vmax.png?1504374324698", id:"vmax"}
	],
	preloads: []
};
